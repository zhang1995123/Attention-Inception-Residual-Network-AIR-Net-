...
class Inception(nn.Module):
    ...
    def __init__(self, num_classes=10, inception_blocks=None):
        ...
        # self.Conv3d_2b_3x3 = BasicConv3d(16, 32, kernel_size=1)
...
class InceptionC(nn.Module):
    ...
    def __init__(self, in_channels, mid_ch=96, conv_block=None):
        super(InceptionC, self).__init__()
        if conv_block is None:
            conv_block = BasicConv3d
        self.branch1x1 = conv_block(in_channels, 64, kernel_size=1)

        self.branch7x7_1 = conv_block(in_channels, mid_ch, kernel_size=1)
        self.branch7x7_2 = conv_block(mid_ch, mid_ch, kernel_size=(1, 1, 3), padding=(0, 0, 1))
        self.branch7x7_3 = conv_block(mid_ch, mid_ch, kernel_size=(1, 3, 1), padding=(0, 1, 0))
        self.branch7x7_4 = conv_block(mid_ch, 64, kernel_size=(3, 1, 1), padding=(1, 0, 0))

        self.branch7x7dbl_1 = conv_block(in_channels, mid_ch, kernel_size=1)
        self.branch7x7dbl_2 = conv_block(mid_ch, mid_ch, kernel_size=(1, 1, 3), padding=(0, 0, 1))
        self.branch7x7dbl_3 = conv_block(mid_ch, mid_ch, kernel_size=(1, 3, 1), padding=(0, 1, 0))
        self.branch7x7dbl_4 = conv_block(mid_ch, 64, kernel_size=(3, 1, 1), padding=(1, 0, 0))
